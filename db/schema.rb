...
ActiveRecord::Schema[7.0].define(version: 2023_04_06_081207) do
  ...
  create_table "users", primary_key: "user_id", id: :bigint, default: -> { "nextval('users_id_seq'::regclass)" }, force: :cascade do |t|
    t.string "user_email_address", default: "", null: false
    ...
    t.index ["user_email_address"], name: "index_users_on_user_email_address", unique: true
  end
